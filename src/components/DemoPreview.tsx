...
const DemoPreview = () => {
  ...
  return (
    <div className="relative max-w-[360px] w-full">
      ...
      <Card className="border-2 border-muted overflow-hidden shadow-xl w-full">
          ...
          <TabsContent value="profile" className="m-0">
            <div className="h-[500px] overflow-y-auto">
              ...
              <div className="flex flex-col items-center -mt-12 px-4">
                <div className="w-24 h-24 rounded-full border-4 border-white bg-muted flex items-center justify-center overflow-hidden">
                  <img 
...
const DemoLink = ({ title, subtitle, icon: Icon }) => {
  return (
    <Card className="p-4 hover:bg-muted transition-colors cursor-pointer flex items-center gap-3">
