...
const SplashScreen = ({ onComplete }: SplashScreenProps) => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      try {
        ...
        console.log('Sound not available, continuing without audio');
      }
  ...
  return (
    <>
      <Helmet>
        <title>Loading Play with Droplink...</title>
        <meta name="description" content="Welcome to Play with Droplink - Your Pi Network Gaming Hub" />
      </Helmet>
